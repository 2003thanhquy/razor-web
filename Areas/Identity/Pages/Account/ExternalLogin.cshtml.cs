    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                //co tai khoan ,chua lien ket => lien ket ngoai dich vu
                //chua co tai khoan ,lien ket dang nhap
                ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //clam: dac tinh mo ta cua doi tuong nao do
                if(info.Principal.HasClaim(c => c.Type == ClaimTypes.Email)){
                ...
                if((externalEmailUser !=null) && (registeredUser != null)){
                    if(externalEmailUser.Id ==registeredUser.Id){
                    ...
                    //
                        ...
                        ModelState.AddModelError(string.Empty, "Khong lien ket tai khoan kiem tra email khac");
                        return Page();
                    }
                }
                 if((externalEmailUser !=null) && (registeredUser == null)){
                     ModelState.AddModelError(string.Empty, "khong ho tro tao tai khoan khac voi email tai khoan ngoai");
                        return Page();
                 }
